...
# Pull revenue change (real) as a vector
econ_change <- econ_impute%>% 
  pull(dollar_diff_real)
summary(econ_change)
# Min.          1st Qu.     Median       Mean    3rd Qu.       Max. 
#-139911239     524045    3975456   34358712   18037557  300618829 
sum(econ_change) #2,886,131,834
```
...
boot_mean_100000$t0 # to report the mean of the original sample =$34,358,712
