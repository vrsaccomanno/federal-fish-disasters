...
#Bias (difference between original sample mean and bootstrapped sampling mean)=$14,723.53
#Std. error (SD of bootstrapped sampling distribution)=$9,752,627
...
boot_med_100000$t0 # Median of the original sample =$3,548,578
boot_med_100000 # to report bias, SE
#Bias (difference between original sample median and bootstrapped sampling median)=$1,195,517
#Std. error (SD of bootstrapped sampling distribution)= $3,177,266
...
# Mean, direct revenue loss in a disaster year is $37,485,736 ($US2019) (n=76), with a boot strapped 95% confidence interval of [$17553115, $55654965] (n= 100,000 bootstrap samples).
...
# Median, direct revenue loss in a disaster year is $3,548,578($US2019) (n=72), with a boot strapped 95% confidence interval of [-$5270491,  $5539234] (n= 100,000 bootstrap samples).
