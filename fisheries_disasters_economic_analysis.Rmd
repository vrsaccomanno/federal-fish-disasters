...
```{r}
#Load data
econ_raw <- read_csv("data/econ_est_R_2.csv")
View(econ_raw)
...
#Bias (difference between original sample mean and bootstrapped sampling mean)= $-8289.469
#Std. error (SD of bootstrapped sampling distribution)=$9768967
...
#Bias (difference between original sample median and bootstrapped sampling median)=$669,888.7
#Std. error (SD of bootstrapped sampling distribution)= $3081214
...
#Intervals : 
#Level      Basic         
#95%   (17686616, 55775565 )  

# Mean, direct revenue loss in a disaster year is $37,558,907 ($US2019) (n=78), with a boot strapped 95% confidence interval of [$17,686,616, $55,775,565] (n= 100,000 bootstrap samples).
