...
#p-value = 3.831e-11 = statisticlly different from a normal distribution


# Pull revenue change (real) as a vector without imputed values (removes the 8 NAs)
...
#-139911239     359470    3428735   36007071   19732564  300618829 
sum(econ_change) #2,808,551,533
...
boot_mean_100000$t0 # to report the mean of the original sample =$36,007,071
boot_mean_100000 # to report bias, SE
#Bias (difference between original sample mean and bootstrapped sampling mean)= $23,241.39
#Std. error (SD of bootstrapped sampling distribution)=$9,418,710
...
boot_med_100000$t0 # Median of the original sample =$3,428,735
boot_med_100000 # to report bias, SE
#Bias (difference between original sample median and bootstrapped sampling median)=$762,541.7
#Std. error (SD of bootstrapped sampling distribution)= $2,601,390
...
#Intervals : 
#Level      Basic         
#95%   (16693561, 53,584,859)  

# Mean, direct revenue loss in a disaster year is $36,007,071 ($US2019) (n=78), with a boot strapped 95% confidence interval of [$16,693,561, 53,584,859] (n= 100,000 bootstrap samples).
...
#Intervals : 
#Level      Basic         
#95%   (-5,031,360,  5,320,699) 

# Median, direct revenue loss in a disaster year is $3,428,735 ($US2019) (n=78), with a boot strapped 95% confidence interval of [-$5,031,360,  $5,320,699)] (n= 100,000 bootstrap samples).
